...
class SampleApplication(Application):
    ...
    async def temperature_get(self, addr, app_index, arguments):
        client = self.elements[0][LightCTLClient]
        result = await client.temperature_get(addr, app_index=app_index)
        print(result)
    ...
    async def temperature_set(self, addr, app_index, arguments):
        ...
        temperature = int(arguments['<temperature>'])
        transition_time = float(arguments['--transition']) if arguments['--transition'] else 0.0
        result = await client.temperature_set(
            addr,
            app_index=app_index,
            ctl_temperature=temperature,
            ctl_delta_uv=0,
    ...
    async def temperature_set_unack(self, addr, app_index, arguments):
        ...
        temperature = int(arguments['<temperature>'])
        transition_time = float(arguments['--transition']) if arguments['--transition'] else 0.0
        await client.temperature_set_unack(
            addr,
            app_index=app_index,
            ctl_temperature=temperature,
            ctl_delta_uv=0,
    ...
    async def temperature_range_get(self, addr, app_index, arguments):
        client = self.elements[0][LightCTLClient]
        result = await client.temperature_range_get(addr, app_index=app_index)
        print(result)
    ...
    async def temperature_range_set(self, addr, app_index, arguments):
        ...
        result = await client.temperature_range_set(
            addr,
            app_index=app_index,
            range_min=range_min,
            range_max=range_max
    ...
    async def temperature_range_set_unack(self, addr, app_index, arguments):
        ...
        range_min = int(arguments['<min>'])
        range_max = int(arguments['<max>'])
        await client.temperature_range_set_unack(
            addr,
            app_index=app_index,
            range_min=range_min,
            range_max=range_max
...
def main():
    ...
    Usage:
        light_ctl_client.py [-V] -a <address> get
        light_ctl_client.py [-V] -a <address> [--transition=<time>] set <lightness> <temperature> [<delta_uv>]
        light_ctl_client.py [-V] -a <address> [--transition=<time>] set_unack <lightness> <temperature> [<delta_uv>]
        light_ctl_client.py [-V] -a <address> t_get
        light_ctl_client.py [-V] -a <address> [--transition=<time>] t_set <temperature> [<delta_uv>]
        light_ctl_client.py [-V] -a <address> [--transition=<time>] t_set_unack <temperature> [<delta_uv>]
        light_ctl_client.py [-V] -a <address> t_range_get
        light_ctl_client.py [-V] -a <address> t_range_set <min> <max>
        light_ctl_client.py [-V] -a <address> t_range_set_unack <min> <max>
        light_ctl_client.py [-V] -a <address> default_get
        light_ctl_client.py [-V] -a <address> [--transition=<time>] default_set <lightness> <temperature> [<delta_uv>]
        light_ctl_client.py [-V] -a <address> [--transition=<time>] default_set_unack <lightness> <temperature> [<delta_uv>]
